...
## 10. Warum unterscheiden sich die HRV-Daten in PeakWatch von denen in Garmin?

Dies liegt an einem Unterschied in der Berechnungsmethode der jeweiligen Plattform:

- **Garmins HRV-Status** zeigt den **Durchschnitt der HRV-Daten der letzten 7 Tage**
- **PeakWatch** zeigt den **Durchschnitt der HRV-Daten des aktuellen Tages**

Daher können die Werte abweichen, auch wenn sie aus derselben Datenquelle stammen – das ist ein normales Verhalten.
