...
## 10. ¿Por qué los datos de HRV en PeakWatch son diferentes a los de Garmin?

Esto se debe a una diferencia en cómo cada plataforma calcula el HRV:

- **El estado HRV de Garmin** muestra el **promedio de los datos de HRV de los últimos 7 días**
- **PeakWatch** muestra el **promedio de los datos de HRV del día actual**

Por lo tanto, incluso utilizando la misma fuente de datos, los valores diferirán; esto es un comportamiento normal.
