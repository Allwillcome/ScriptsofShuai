...
## 12. Why is the HRV data in PeakWatch different from Garmin's?

This is due to a difference in how each platform calculates HRV:

- **Garmin HRV Status** displays the **average of the past 7 days' HRV data**
- **PeakWatch** displays the **average of the current day's HRV data**

Therefore, even when drawing from the same data source, the values will differ—this is expected behavior.
